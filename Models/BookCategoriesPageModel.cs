...
namespace Varro_Szilard_Arnold_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Varro_Szilard_Arnold_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Varro_Szilard_Arnold_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
